{application,rabbit_common,
             [{description,[]},
              {vsn,[]},
              {id,"git"},
              {modules,[app_utils,code_version,credit_flow,gen_server2,
                        ...
                        rabbit_event,rabbit_exchange_decorator,
                        ...
                        rabbit_runtime_parameter,rabbit_types,rabbit_writer,
                        ssl_compat,supervisor2,time_compat]},
              {registered,[]},
